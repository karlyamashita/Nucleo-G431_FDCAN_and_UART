...
For this example I don't have the FDCAN peripheral enabled. But I have 3 arrays with different data that I add to the ring buffer. Then I call transmit_mdb() to transmit all available UART messages. All 3 messages will get sent.
